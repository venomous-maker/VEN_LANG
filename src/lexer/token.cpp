...
TOKEN Token::determine_token_type(int final_state, std::string &value) {
    switch(final_state) {
		...
		if(value == "include" || value =="import" || value == "load")
                return TOK_INCLUDE;
            if(value == "var" || value == "variable" || value == "attribute" || value == "define" || value == "$")
                return TOK_VAR;
            if(value == "set" || value == "change" || value == "reassign" || value == "redeclare" || value == "assign" || value == "declare")
                return TOK_SET;
            if(value == "def" || value == "define" || value == "function" || value == "method" || value == "func")
                return TOK_DEF;
            ...
            if(value == "while")
                return TOK_WHILE;
            if(value == "print" || value == "printf" || value == "echo" || value == "display" || value == "println" || value == "out" || value == "writeln" || value == "writeout")
                return TOK_PRINT;
            if(value == "int" || value == "num" || value == "integer" || value == "number")
                return TOK_INT_TYPE;
